...
最終更新: 2026-03-28 / 対応バージョン: v1.5.17

> 実装予定・ロードマップは [roadmap.md](../updates/roadmap.md) を参照してください。

---

## 最新完了機能（v1.4.718〜v1.5.17）
...
| GEN-9: 「今日の気分」ボタン（ランダムテンプレ適用） | v1.5.16 |
| OUTPUT-9: プロンプト差分ビューア（Positive/Negative差分表示、トグル対応） | v1.5.17 |
...
| 今日の気分ボタン（キャラプリセットをランダム適用） | v1.5.16 |
